...
CREATE TABLE "carousel_items_old" (
	"_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "carousel_items_old__id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 17417 CACHE 1),
	"store_carousel_id" bigint NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "posts" (
	"_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "posts__id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 17417 CACHE 1),
...
CREATE TABLE "store_carousel" (
	"_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "store_carousel__id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 17417 CACHE 1),
	"store_id" uuid NOT NULL,
...
CREATE TABLE "store_carousel_old" (
	"_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "store_carousel_old__id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 17417 CACHE 1),
	"store_id" uuid NOT NULL,
	"created_at" timestamp DEFAULT now() NOT NULL,
	"updated_at" timestamp DEFAULT now() NOT NULL,
...
CREATE TABLE "store_order" (
	"_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "store_order__id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 17417 CACHE 1),
...
CREATE TABLE "store_order_item" (
	"_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "store_order_item__id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 17417 CACHE 1),
...
CREATE TABLE "store_product" (
	"_id" bigint PRIMARY KEY GENERATED ALWAYS AS IDENTITY (sequence name "store_product__id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 9223372036854775807 START WITH 17417 CACHE 1),
	"store_id" uuid NOT NULL,
	"product_name" varchar(255) NOT NULL,
...
ALTER TABLE "comments" ADD CONSTRAINT "comments_post_id_posts__id_fk" FOREIGN KEY ("post_id") REFERENCES "public"."posts"("_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "store_order" ADD CONSTRAINT "store_order_store_owner_id_users__id_fk" FOREIGN KEY ("store_owner_id") REFERENCES "public"."users"("_id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "follow_lists" ADD CONSTRAINT "follow_lists_following_id_users__id_fk" FOREIGN KEY ("following_id") REFERENCES "public"."users"("_id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
